...
def TranslateText():
    ...
    try:
        ...
        words_count, sentences_count = CountWS(text)
        ...
        if output_mode == 'first_tank.txt':
            output_filename = f"translated_{input_filename}_{target_language}.txt"
